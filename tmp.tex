...
Como a propriedade \ensuremath{\Varid{check}} é mais fraca do que a propriedade
\ensuremath{\Varid{checkFiles}} então para todos os casos em que \ensuremath{\Varid{checkFiles}}
é verdadeira, \ensuremath{\Varid{check}} também o será.\newline
É então evidente que \ensuremath{\Varid{prop\char95 new}} será válida ao fazer
a substituição para \ensuremath{\Varid{check}} (assumindo que
já o era com \ensuremath{\Varid{checkFiles}}).
\end{propriedade}
