...
A propriedade \ensuremath{\Varid{check}} é mais "restritiva" do que a propriedade
\ensuremath{\Varid{checkFiles}}, isto quer dizer que \ensuremath{\Varid{checkFiles}} é verdadeira
para todos os valores que \ensuremath{\Varid{check}} é verdadeira, sendo assim,
ao substituir \ensuremath{\Varid{checkFiles}} por \ensuremath{\Varid{check}}, se \ensuremath{\Varid{prop\char95 new}} for
...
\\
\>[B]{}\Varid{inExpr}\mathrel{=}\alt{\Conid{Num}}{\Varid{in2Expr}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{in2Expr}\;(\Varid{o},(\Varid{e},\Varid{e'}))\mathrel{=}\Conid{Bop}\;\Varid{e}\;\Varid{o}\;\Varid{e'}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{outExpr}\mathbin{::}\Conid{Expr}\to \Conid{Int}+(\Conid{Op},(\Conid{Expr},\Conid{Expr})){}\<[E]%
\\
\>[B]{}\Varid{outExpr}\;(\Conid{Num}\;\Varid{x})\mathrel{=}i_1\;\Varid{x}{}\<[E]%
\\
\>[B]{}\Varid{outExpr}\;(\Conid{Bop}\;\Varid{e}\;\Varid{o}\;\Varid{e'})\mathrel{=}i_2\;(\Varid{o},(\Varid{e},\Varid{e'})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{inOp}\mathbin{::}\Conid{String}\to \Conid{Op}{}\<[E]%
\\
\>[B]{}\Varid{inOp}\;\Varid{s}\mathrel{=}\Conid{Op}\;\Varid{s}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{outOp}\mathbin{::}\Conid{Op}\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{outOp}\;(\Conid{Op}\;\Varid{s})\mathrel{=}\Varid{s}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{recExpr}\mathrel{=}\Varid{baseExpr}\;\Varid{id}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{hyloExpr}\;\Varid{g}\;\Varid{h}\mathrel{=}\Varid{cataExpr}\;\Varid{h}\comp \Varid{anaExpr}\;\Varid{g}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{bopTable}\mathrel{=}[\mskip1.5mu (\text{\ttfamily \char34 +\char34},(\uncurry{(\mathbin{+})},\text{\ttfamily \char34 ADD\char34})){}\<[E]%
\\
\>[B]{}\hsindent{12}{}\<[12]%
\>[12]{},(\text{\ttfamily \char34 -\char34},(\uncurry{(\mathbin{-})},\text{\ttfamily \char34 SUB\char34})){}\<[E]%
\\
\>[B]{}\hsindent{12}{}\<[12]%
\>[12]{},(\text{\ttfamily \char34 *\char34},(\uncurry{(\mathbin{*})},\text{\ttfamily \char34 MUL\char34})){}\<[E]%
\\
\>[B]{}\hsindent{12}{}\<[12]%
\>[12]{}\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{bop2Func}\mathrel{=}\mathsf{fmap}\;\p1\comp \Varid{flip}\;\Varid{lookup}\;\Varid{bopTable}{}\<[E]%
\\
\>[B]{}\Varid{bop2St}{}\<[10]%
\>[10]{}\mathrel{=}\mathsf{fmap}\;\p2\comp \Varid{flip}\;\Varid{lookup}\;\Varid{bopTable}{}\<[E]%
\\
\>[B]{}\Varid{bopExtr}\;\Varid{f}\mathrel{=}\Varid{fromJust}\comp \Varid{f}\comp \Varid{outOp}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calcula}\mathbin{::}\Conid{Expr}\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{calcula}\mathrel{=}\Varid{cataExpr}\;\alt{\Varid{id}}{\Varid{\Conid{Cp}.ap}\comp (\Varid{bopExtr}\;\Varid{bop2Func}\times\Varid{id})}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{show'}\mathbin{::}\Conid{Expr}\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{show'}\mathrel{=}\Varid{cataExpr}\;\alt{\Varid{show}}{\Varid{showBop}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{showBop}\;(\Varid{op},(\Varid{es},\Varid{es'}))\mathrel{=}\Varid{concat}\mathbin{\$}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}[\mskip1.5mu \text{\ttfamily \char34 (\char34},\Varid{es},\text{\ttfamily \char34 ~\char34},\Varid{outOp}\;\Varid{op},\text{\ttfamily \char34 ~\char34},\Varid{es'},\text{\ttfamily \char34 )\char34}\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{compile}\mathbin{::}\Conid{String}\to \Conid{Codigo}{}\<[E]%
\\
\>[B]{}\Varid{compile}\mathrel{=}\Varid{cataExpr}\;\alt{\Varid{printPush}}{\Varid{printBop}}\comp \Varid{read}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{printPush}\mathrel{=}\Varid{pure}\comp (\plus )\;\text{\ttfamily \char34 PUSH~\char34}\comp \Varid{show}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{printBop}\;(\Varid{op},(\Varid{es},\Varid{es'}))\mathrel{=}\Varid{concat}\;[\mskip1.5mu \Varid{es},\Varid{es'},[\mskip1.5mu \Varid{bopExtr}\;\Varid{bop2St}\;\Varid{op}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
A função readExp devolve uma lista com os possíveis parses
da string,
\begin{tabbing}\ttfamily
~\char62{}~\char58{}i~ReadS\\
\ttfamily ~type~ReadS~a~\char61{}~String~\char45{}\char62{}~\char91{}\char40{}a\char44{}~String\char41{}\char93{}
\end{tabbing}
...
\column{23}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{readExpr'}\mathbin{::}\Conid{String}\to \Conid{Expr}{}\<[E]%
\\
\>[B]{}\Varid{readExpr'}\mathrel{=}\Varid{anaExpr}\;\Varid{g}\comp \Varid{filter}\;(\not\equiv \text{\ttfamily '~'}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{g}\mathbin{::}\Conid{String}\to \Conid{Int}+(\Conid{Op},(\Conid{String},\Conid{String})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{g}\;\Varid{s}\mathrel{=}\Varid{head}\mathbin{\$}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}(\map \;i_2\comp \Varid{concat}\mathbin{\$}{}\<[E]%
\\
\>[11]{}\hsindent{2}{}\<[13]%
\>[13]{}[\mskip1.5mu \Varid{findParen}\;\Varid{findOps}\;\Varid{s}{}\<[E]%
\\
\>[11]{}\hsindent{2}{}\<[13]%
\>[13]{},\Varid{findOps}\;\Varid{s}\mskip1.5mu]{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{})\plus {}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}(\map \;i_1\comp \Varid{concat}\mathbin{\$}{}\<[E]%
\\
\>[11]{}\hsindent{2}{}\<[13]%
\>[13]{}[\mskip1.5mu \Varid{findNum}\;\Varid{s}{}\<[E]%
\\
\>[11]{}\hsindent{2}{}\<[13]%
\>[13]{},\Varid{findParen}\;\Varid{findNum}\;\Varid{s}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\mskip1.5mu])\plus {}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}[\mskip1.5mu \Varid{errorWithoutStackTrace}\;\text{\ttfamily \char34 no~parse.\char34}\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{findParen}\mathbin{::}(\Conid{String}\to [\mskip1.5mu \Varid{a}\mskip1.5mu])\to \Conid{String}\to [\mskip1.5mu \Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{findParen}\;\Varid{f}\;(\text{\ttfamily '('}\mathbin{:}\Varid{str})\mathrel{=}\Varid{f}\mathbin{\$}\Varid{findParen'}\;(\Varid{str},[\mskip1.5mu \mskip1.5mu])\;\mathrm{1}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{findParen'}\mathbin{::}(\Conid{String},\Conid{String})\to \Conid{Int}\to \Conid{String}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{findParen'}\;([\mskip1.5mu \mskip1.5mu],\Varid{xxs'})\;\mathrm{0}\mathrel{=}\mathbf{if}\;\Varid{last}\;\Varid{xxs'}\equiv \text{\ttfamily ')'}\;\mathbf{then}\;\Varid{init}\;\Varid{xxs'}\;\mathbf{else}\;[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{findParen'}\;([\mskip1.5mu \mskip1.5mu],\anonymous )\;\anonymous \mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{findParen'}\;(\text{\ttfamily '('}\mathbin{:}\Varid{xs},\Varid{xxs'})\;\Varid{n}\mathrel{=}\Varid{findParen'}\;(\Varid{xs},\Varid{xxs'}\plus \text{\ttfamily \char34 (\char34})\;(\Varid{n}\mathbin{+}\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{findParen'}\;(\text{\ttfamily ')'}\mathbin{:}\Varid{xs},\Varid{xxs'})\;\Varid{n}\mathrel{=}\Varid{findParen'}\;(\Varid{xs},\Varid{xxs'}\plus \text{\ttfamily \char34 )\char34})\;(\Varid{n}\mathbin{-}\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{findParen'}\;(\Varid{x}\mathbin{:}\Varid{xs},\Varid{xxs'})\;\Varid{n}\mathrel{=}\Varid{findParen'}\;(\Varid{xs},\Varid{xxs'}\plus [\mskip1.5mu \Varid{x}\mskip1.5mu])\;\Varid{n}{}\<[E]%
\\
\>[B]{}\Varid{findParen}\;\anonymous \;\anonymous \mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{findNum}\mathbin{::}\Conid{String}\to [\mskip1.5mu \Conid{Int}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{findNum}\mathrel{=}\map \;\p1\comp \Varid{reads}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{findOps}\mathbin{::}\Conid{String}\to [\mskip1.5mu (\Conid{Op},(\Conid{String},\Conid{String}))\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{findOps}\;\Varid{s}\mathrel{=}\Varid{concat}\;[\mskip1.5mu \Varid{findOp}\;\text{\ttfamily \char34 +\char34}\;\Varid{s}{}\<[E]%
\\
\>[B]{}\hsindent{20}{}\<[20]%
\>[20]{},\Varid{findOp}\;\text{\ttfamily \char34 -\char34}\;\Varid{s}{}\<[E]%
\\
\>[B]{}\hsindent{20}{}\<[20]%
\>[20]{},\Varid{findOp}\;\text{\ttfamily \char34 *\char34}\;\Varid{s}\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{findOp}\mathbin{::}\Conid{String}\to \Conid{String}\to [\mskip1.5mu (\Conid{Op},(\Conid{String},\Conid{String}))\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{findOp}\;\Varid{op}\;\Varid{str}\mathrel{=}\Varid{findOp'}\;\Varid{op}\;(\Varid{str},[\mskip1.5mu \mskip1.5mu])\;\mathrm{0}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{findOp'}\;\Varid{op}\;([\mskip1.5mu \mskip1.5mu],\anonymous )\;\anonymous \mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{findOp'}\;\Varid{op}\;(\text{\ttfamily '('}\mathbin{:}\Varid{xs},\Varid{xxs'})\;\Varid{n}\mathrel{=}\Varid{findOp'}\;\Varid{op}\;(\Varid{xs},\Varid{xxs'}\plus \text{\ttfamily \char34 (\char34})\;(\Varid{n}\mathbin{+}\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{findOp'}\;\Varid{op}\;(\text{\ttfamily ')'}\mathbin{:}\Varid{xs},\Varid{xxs'})\;\Varid{n}\mathrel{=}\Varid{findOp'}\;\Varid{op}\;(\Varid{xs},\Varid{xxs'}\plus \text{\ttfamily \char34 )\char34})\;(\Varid{n}\mathbin{-}\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{findOp'}\;\Varid{op}\;(\Varid{xxs}\mathord{@}(\Varid{x}\mathbin{:}\Varid{xs}),\Varid{xxs'})\;\Varid{n}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\mid \Varid{validMatch}\mathrel{=}[\mskip1.5mu (\Conid{Op}\;\Varid{op},(\Varid{xxs'},\Varid{drop}\;(\length \;\Varid{op})\;\Varid{xxs}))\mskip1.5mu]{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\mid \Varid{otherwise}\mathrel{=}\Varid{findOp'}\;\Varid{op}\;(\Varid{xs},\Varid{xxs'}\plus [\mskip1.5mu \Varid{x}\mskip1.5mu])\;\Varid{n}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{validMatch}\mathrel{=}{}\<[23]%
\>[23]{}\Varid{isPrefixOf}\;\Varid{op}\;\Varid{xxs}\mathrel{\wedge}\Varid{n}\equiv \mathrm{0}{}\<[E]%
\\
\>[9]{}\hsindent{11}{}\<[20]%
\>[20]{}\mathrel{\wedge}\neg \;(\Varid{null}\;\Varid{xs})\mathrel{\wedge}\neg \;(\Varid{null}\;\Varid{xxs'}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{inL2D}\;(i_1\;\Varid{sb})\mathrel{=}\Conid{Unid}\;\Varid{sb}{}\<[E]%
\\
\>[B]{}\Varid{inL2D}\;(i_2\;(\Varid{ty},(\Varid{cb},\Varid{cb'})))\mathrel{=}\Conid{Comp}\;\Varid{ty}\;\Varid{cb}\;\Varid{cb'}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{outL2D}\mathbin{::}\Conid{X}\;\Varid{a}\;\Varid{b}\to \Varid{a}+(\Varid{b},(\Conid{X}\;\Varid{a}\;\Varid{b},\Conid{X}\;\Varid{a}\;\Varid{b})){}\<[E]%
\\
\>[B]{}\Varid{outL2D}\;(\Conid{Unid}\;\Varid{sb})\mathrel{=}i_1\;\Varid{sb}{}\<[E]%
\\
\>[B]{}\Varid{outL2D}\;(\Conid{Comp}\;\Varid{ty}\;\Varid{cb}\;\Varid{cb'})\mathrel{=}i_2\;(\Varid{ty},(\Varid{cb},\Varid{cb'})){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{collectLeafs}\mathrel{=}\Varid{cataL2D}\;\alt{\Varid{pure}}{\mathsf{conc}\comp \p2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calcDim}\;\Conid{V}{}\<[12]%
\>[12]{}\mathrel{=}\lambda (\Varid{w},\Varid{h})\;(\Varid{w'},\Varid{h'})\to (\Varid{max}\;\Varid{w}\;\Varid{w'},\Varid{h}\mathbin{+}\Varid{h'}){}\<[E]%
\\
\>[B]{}\Varid{calcDim}\;\Conid{Ve}\mathrel{=}\lambda (\Varid{w},\Varid{h})\;(\Varid{w'},\Varid{h'})\to (\Varid{max}\;\Varid{w}\;\Varid{w'},\Varid{h}\mathbin{+}\Varid{h'}){}\<[E]%
\\
\>[B]{}\Varid{calcDim}\;\Conid{H}{}\<[12]%
\>[12]{}\mathrel{=}\lambda (\Varid{w},\Varid{h})\;(\Varid{w'},\Varid{h'})\to (\Varid{w}\mathbin{+}\Varid{w'},\Varid{max}\;\Varid{h}\;\Varid{h'}){}\<[E]%
\\
\>[B]{}\Varid{calcDim}\;\Conid{Hb}\mathrel{=}\lambda (\Varid{w},\Varid{h})\;(\Varid{w'},\Varid{h'})\to (\Varid{w}\mathbin{+}\Varid{w'},\Varid{max}\;\Varid{h}\;\Varid{h'}){}\<[E]%
\\
\>[B]{}\Varid{calcDim}\;\anonymous {}\<[12]%
\>[12]{}\mathrel{=}\lambda (\Varid{w},\Varid{h})\;(\Varid{w'},\Varid{h'})\to (\Varid{w}\mathbin{+}\Varid{w'},\Varid{h}\mathbin{+}\Varid{h'}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dimen}\mathbin{::}\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo}\to (\Conid{Float},\Conid{Float}){}\<[E]%
\\
\>[B]{}\Varid{dimen}\mathrel{=}(\Varid{fromIntegral}\times\Varid{fromIntegral}){}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\comp \Varid{cataL2D}\;\alt{\p1}{\Varid{joinDimen}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{joinDimen}\mathrel{=}\Varid{\Conid{Cp}.ap}\comp ((\uncurry{\cdot }\comp \Varid{calcDim})\times\Varid{id}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calcOrigins}\mathbin{::}((\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo}),\Conid{Origem})\to \Conid{X}\;(\Conid{Caixa},\Conid{Origem})\;(){}\<[E]%
\\
\>[B]{}\Varid{calcOrigins}\mathrel{=}\Varid{anaL2D}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{g}\mathrel{=}(\Varid{id}+\Varid{calcOrig})\comp \Varid{distl}\comp (\Varid{outL2D}\times\Varid{id}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{calcOrig}\;((\Varid{t},(\Varid{l2d},\Varid{l2d'})),\Varid{o})\mathrel{=}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}((),((\Varid{l2d},\Varid{o}),(\Varid{l2d'},\Varid{calc}\;\Varid{t}\;\Varid{o}\mathbin{\$}\Varid{dimen}\;\Varid{l2d}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calc}\mathbin{::}\Conid{Tipo}\to \Conid{Origem}\to (\Conid{Float},\Conid{Float})\to \Conid{Origem}{}\<[E]%
\\
\>[B]{}\Varid{calc}\;\Varid{t}\;(\Varid{o1},\Varid{o2})\;(\Varid{w},\Varid{h})\mathrel{=}\mathbf{case}\;\Varid{t}\;\mathbf{of}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Conid{Hb}\to (\Varid{o1}\mathbin{+}\Varid{w},\Varid{o2}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Conid{H}{}\<[8]%
\>[8]{}\to (\Varid{o1}\mathbin{+}\Varid{w},\Varid{o2}\mathbin{+}\Varid{h}\mathbin{/}\mathrm{2}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Conid{Ve}\to (\Varid{o1},\Varid{o2}\mathbin{+}\Varid{h}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Conid{V}{}\<[8]%
\>[8]{}\to (\Varid{o1}\mathbin{+}\Varid{w}\mathbin{/}\mathrm{2},\Varid{o2}\mathbin{+}\Varid{h}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{otherwise}\to (\Varid{o1}\mathbin{+}\Varid{w},\Varid{o2}\mathbin{+}\Varid{h}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{agrup\char95 caixas}\mathbin{::}\Conid{X}\;(\Conid{Caixa},\Conid{Origem})\;()\to \Conid{Fig}{}\<[E]%
\\
\>[B]{}\Varid{agrup\char95 caixas}\mathrel{=}\Varid{cataL2D}\;\alt{\Varid{pure}\comp \Varid{swap}}{\mathsf{conc}\comp \p2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{caixasAndOrigin2Pict}\mathbin{::}((\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo}),\Conid{Origem})\to \Conid{\Conid{G}.Picture}{}\<[E]%
\\
\>[B]{}\Varid{caixasAndOrigin2Pict}\mathrel{=}\Conid{\Conid{G}.Pictures}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\comp \map \;(\lambda (\Varid{o},((\Varid{w},\Varid{h}),(\Varid{t},\Varid{c})))\to \Varid{crCaixa}\;\Varid{o}\;(\Varid{fromIntegral}\;\Varid{w})\;(\Varid{fromIntegral}\;\Varid{h})\;\Varid{t}\;\Varid{c}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\comp \Varid{agrup\char95 caixas}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\comp \Varid{calcOrigins}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{loop}\;(\Varid{cos},\Varid{h},\Varid{f},\Varid{k})\mathrel{=}(\Varid{h}\mathbin{+}\Varid{cos},((\mathbin{-}\Varid{x}\mathbin{\uparrow}\mathrm{2})\mathbin{/}\Varid{f})\mathbin{*}\Varid{h},\Varid{f}\mathbin{+}\Varid{k},\Varid{k}\mathbin{+}\mathrm{8}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{prj}\;(\Varid{cos},\Varid{h},\Varid{f},\Varid{g})\mathrel{=}\Varid{cos}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

\begin{tabbing}\ttfamily
~~~~~double~cos\char40{}double~x\char44{}~int~n\char41{}\char123{}\\
\ttfamily ~~~~~~~~~double~r\char61{}1\char59{}\\
\ttfamily ~~~~~~~~~double~h\char61{}\char45{}pow\char40{}x\char44{}2\char41{}\char47{}2\char59{}\\
\ttfamily ~~~~~~~~~double~f\char61{}12\char59{}\\
\ttfamily ~~~~~~~~~double~k\char61{}18\char59{}\\
\ttfamily ~~~~~~~~~for\char40{}int~i\char61{}0\char59{}~i\char60{}n\char59{}~i\char43{}\char43{}\char41{}\char123{}\\
\ttfamily ~~~~~~~~~~~~~r\char43{}\char61{}h\char59{}\\
\ttfamily ~~~~~~~~~~~~~h\char61{}\char40{}\char45{}pow\char40{}x\char44{}2\char41{}\char47{}f\char41{}\char42{}h\char59{}\\
\ttfamily ~~~~~~~~~~~~~f\char43{}\char61{}k\char59{}\\
\ttfamily ~~~~~~~~~~~~~k\char43{}\char61{}8\char59{}\\
\ttfamily ~~~~~~~~~\char125{}\\
...
\\
\>[B]{}\Varid{outNode}\;(\Conid{Dir}\;\Varid{n}){}\<[18]%
\>[18]{}\mathrel{=}i_2\;\Varid{n}{}\<[E]%
\\[\blanklineskip]%
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{cataFSdist}\;\Varid{f}\mathrel{=}\Varid{cataFS}\;(\Varid{f}\comp \Varid{partitionEithers}\comp \map \;\Varid{distr}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{check}\mathbin{::}(\Conid{Eq}\;\Varid{a})\Rightarrow \Conid{FS}\;\Varid{a}\;\Varid{b}\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{check}\mathrel{=}{}\<[10]%
\>[10]{}\Varid{cataFS}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{g}\mathrel{=}\uncurry{(\mathrel{\wedge})}\comp \conj{\neg \comp \Varid{hasRepeated}\comp \map \;\p1}{\Varid{and}\comp \Varid{rights}\comp \map \;\p2}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{hasRepeated}\mathrel{=}\uncurry{(\not\equiv )}\comp \conj{\Varid{id}}{\Varid{nub}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{tar}\mathbin{::}\Conid{FS}\;\Varid{a}\;\Varid{b}\to [\mskip1.5mu (\Conid{Path}\;\Varid{a},\Varid{b})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{tar}\mathrel{=}\Varid{cataFSdist}\;(\mathsf{conc}\comp (\map \;(\Varid{pure}\times\Varid{id})\times\Varid{concat}\comp \map \;\Varid{addPath})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{addPath}\;(\Varid{a},\Varid{fs})\mathrel{=}\map \;((\Varid{a}\mathbin{:})\times\Varid{id})\;\Varid{fs}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{untar}\mathrel{=}\Varid{anaFS}\;(\map \;\Varid{undistr}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\comp \Varid{uniteEithers}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\comp (\map \;(\Varid{id}\times\p2)\times\Varid{collectEq}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\comp \Varid{partition}\;(\Varid{null}\comp \p1\comp \p2){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\comp \map \;(\lambda ((\Varid{a}\mathbin{:}\Varid{as}),\Varid{b})\to (\Varid{a},(\Varid{as},\Varid{b})))){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{uniteEithers}\;(\Varid{l},\Varid{r})\mathrel{=}\map \;i_1\;\Varid{l}\plus \map \;i_2\;\Varid{r}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{collectEq}\;\Varid{l}\mathrel{=}[\mskip1.5mu (\Varid{a},[\mskip1.5mu \Varid{b}\mid (\anonymous ,\Varid{b})\leftarrow \Varid{filter}\;((\equiv \Varid{a})\comp \p1)\;\Varid{l}\mskip1.5mu])\mid \Varid{a}\leftarrow \Varid{nub}\mathbin{\$}\map \;\p1\;\Varid{l}\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{find}\;\Varid{a}\mathrel{=}\Varid{cataFSdist}\;(\mathsf{conc}\comp (\Varid{findLeft}\times\Varid{findRight})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{findLeft}\mathrel{=}\map \;\Varid{pure}\comp \Varid{filter}\;(\equiv \Varid{a})\comp \map \;\p1{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{findRight}\mathrel{=}\Varid{concat}\comp \map \;(\lambda (\Varid{a},\Varid{pths})\to \map \;(\Varid{a}\mathbin{:})\;\Varid{pths}){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{new}\mathrel{=}(\Varid{curry}\comp \Varid{curry})\;(\Varid{anaFS}\;\Varid{g}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{g}\mathrel{=}\uncurry{\Varid{dist}}\comp (\Varid{id}\times\Varid{outFS}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{dist}\;([\mskip1.5mu \mskip1.5mu],\Varid{b}){}\<[19]%
\>[19]{}\mathrel{=}\map \;(\Varid{id}\times\Varid{second}\;(\lambda \Varid{fs}\to (([\mskip1.5mu \mskip1.5mu],\Varid{b}),\Varid{fs}))){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{dist}\;([\mskip1.5mu \Varid{a}\mskip1.5mu],\Varid{b}){}\<[19]%
\>[19]{}\mathrel{=}((\Varid{a},i_1\;\Varid{b})\mathbin{:})\comp \Varid{dist}\;([\mskip1.5mu \mskip1.5mu],\Varid{b}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{dist}\;(\Varid{a}\mathbin{:}\Varid{as},\Varid{b})\mathrel{=}\map \;(\Varid{undistr}\comp \Varid{second}\;(\lambda (\Varid{a'},\Varid{fs})\to (\Varid{a'},((\mathbf{if}\;\Varid{a}\equiv \Varid{a'}\;\mathbf{then}\;\Varid{as}\;\mathbf{else}\;[\mskip1.5mu \mskip1.5mu],\Varid{b}),\Varid{fs})))\comp \Varid{distr}){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{cp}\;\Varid{p}\;\Varid{p'}\mathrel{=}\Varid{untar}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\comp \Varid{\Conid{Cp}.ap}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\comp \conj{\Varid{maybe}\;\Varid{id}\;(\mathbin{:})\comp \Varid{searchFile}}{\Varid{id}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\comp \Varid{tar}{}\<[E]%
\\
...
\\
\>[5]{}\hsindent{1}{}\<[6]%
\>[6]{}\Varid{searchFile}\mathrel{=}\Varid{liftM}\;\conj{\underline{\Varid{p'}}}{\Varid{id}}\comp \Varid{lookup}\;\Varid{p}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{rm}\mathrel{=}\Varid{curry}\;(\Varid{anaFS}\;\Varid{g}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{dist}\;[\mskip1.5mu \mskip1.5mu]{}\<[14]%
\>[14]{}\mathrel{=}\map \;(\Varid{id}\times\Varid{second}\;(\lambda \Varid{fs}\to ([\mskip1.5mu \mskip1.5mu],\Varid{fs}))){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{dist}\;[\mskip1.5mu \Varid{a}\mskip1.5mu]\mathrel{=}\Varid{filter}\;(\lambda (\Varid{a'},\Varid{bfs})\to \alt{\underline{(\Varid{a}\not\equiv \Varid{a'})}}{\Varid{true}}\;\Varid{bfs})\comp \Varid{dist}\;[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{dist}\;(\Varid{a}\mathbin{:}\Varid{as})\mathrel{=}\map \;(\Varid{undistr}\comp \Varid{second}\;(\lambda (\Varid{a'},\Varid{fs})\to (\Varid{a'},((\mathbf{if}\;\Varid{a}\equiv \Varid{a'}\;\mathbf{then}\;\Varid{as}\;\mathbf{else}\;[\mskip1.5mu \mskip1.5mu]),\Varid{fs})))\comp \Varid{distr}){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{auxJoin}\;(\Varid{l},\Varid{d})\mathrel{=}\map \;(\Varid{id}\times(\Varid{id}+\lambda \Varid{c}\to (\Varid{d},\Varid{c})))\;\Varid{l}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cFS2Exp}\mathbin{::}\Varid{a}\to \Conid{FS}\;\Varid{a}\;\Varid{b}\to (\Conid{Exp}\;()\;\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{cFS2Exp}\mathrel{=}\Varid{curry}\;(\Varid{anaExp}\;\Varid{g}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{g}\mathrel{=}i_2\comp (\Varid{id}\times(\map \;(\alt{\Varid{id}\times\underline{(\Conid{FS}\;[\mskip1.5mu \mskip1.5mu])}}{\Varid{id}}\comp \Varid{distr})\comp \Varid{outFS})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
